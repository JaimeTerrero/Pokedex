        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeeId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pokemons_Types_TipoPrimario",
                        column: x => x.TipoPrimario,
                        principalTable: "Types",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pokemons_Types_TypeeId",
                        column: x => x.TypeeId,
                        principalTable: "Types",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pokemons_TipoPrimario",
                table: "Pokemons",
                column: "TipoPrimario");

            migrationBuilder.CreateIndex(
                name: "IX_Pokemons_TypeeId",
                table: "Pokemons",
                column: "TypeeId");
        }
